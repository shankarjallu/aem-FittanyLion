  ...
  try {
	...
	//  Timestamp timestamp = new Timestamp(System.currentTimeMillis());
	   if (dataSource != null) {
	    ...
	    String query = " insert into CUST (CUST_ID, CUST_FST_NM, CUST_LA_NM, CUST_DOB_RNG_DS, CUST_EMAIL_AD, CUST_PW_ID, CUST_PENN_STE_UNIV_ALUM_IN, CUST_RCD_MNTD_ID, CUST_RCD_MNTD_TS)" +
	     " values (?, ?, ?, ?, ?, ?, ?, ?, ?)";
