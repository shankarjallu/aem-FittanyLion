...
public class RegistrationDBService {
    ...
    public DataSource getDataSource(String dataSourceName,DataSourcePool dataSourceService) {
        ...
        try {
            ...
            System.out.println("erorrrrrrrrrrrrr");
...
//		Date CUST_RCD_MNTD_TS = null;
        ...
        try {
            ...
            if(dataSource != null) {
                ...
                //this will give the increment value for customer id
                //   String incrementval =   "select cust_id.nextval from dual";

                String query = "INSERT INTO CUST (CUST_ID, CUST_FRST_NM,CUST_LST_NM,CUST_DOB_RNG_DS,\r\n" +
                        "		        			  CUST_EMAIL_AD,CUST_PW_ID,CUST_RCD_MNTD_ID,CUST_RCD_MNTD_TS)\r\n" +
                        "VALUES ('09878','gowrishankar','jallu','25','shankar@gmail.com','Y1','abhi1',SYSTIMESTAMP)";
